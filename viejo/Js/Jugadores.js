...
//Jugadores masculinos con sus caracter�sticas
//hombre = ["Jugador", derecha, rev�s,volea,dejada,velocidad,resistencia,servicio,fuerza,resto,consistencia,forma,"superfice"];
...
hombre3=["Almagro, Nicol�s(ESP)",8,9,8,7,8,8,9,9,8,8,10,"clay"];
hombre245=["Alund, Mart�n(ARG)",7,6,5,6,8,7,6,6,7,6,10,"clay"];
...
hombre7=["And�jar, Pablo(ESP)",8,8,6,5,7,8,6,7,8,8,10,"clay"];
hombre247=["Arguello, Facundo(ARG)",7,6,6,6,8,7,6,5,7,6,10,"clay"];
hombre293=["Artu�edo, Andr�s(ESP)",7,6,6,5,7,6,7,6,6,6,10,"clay"];
...
hombre288=["Carball�s, Roberto(ESP)",7,6,5,5,7,6,6,6,8,6,10,"clay"];
hombre197=["Carre�o-Busta, Pablo(ESP)",6,7,6,6,8,8,8,7,7,8,10,"clay"];
hombre23=["Capdeville, Paul(CHI)",7,6,6,6,6,6,7,7,6,6,10,"clay"];
hombre234=["Cervantes, I�igo(ESP)",7,6,4,7,8,7,5,6,7,7,10,"clay"];
...
hombre38=["Del Potro, Juan Mart�n(ARG)",9,9,7,7,9,8,9,10,8,9,10,"neutral"];
...
hombre283=["D�ez, Steven(CAN)",7,5,6,5,6,6,6,6,7,8,10,"hardcourt"];
...
hombre367=["Dom�ngues, Joao(POR)",8,5,5,5,7,8,6,6,7,7,10,"clay"];
...
hombre222=["El�as, Gastao(POR)",7,6,5,6,8,7,6,8,7,7,10,"clay"];
...
hombre380=["Gald�s, Sergio(PER)",7,7,4,6,7,8,5,6,7,7,10,"clay"];
hombre51=["Garc�a-L�pez, Guillermo(ESP)",8,7,7,6,8,8,8,7,7,10,10,"clay"];
hombre284=["Gar�n, Christian(CHI)",8,6,4,5,7,7,6,8,7,6,10,"clay"];
...
hombre365=["G�mez, Emilio(ECU)",8,6,5,5,8,7,6,7,6,6,10,"clay"];
hombre315=["Gonz�lez, Alejandro(COL)",7,6,5,6,7,8,6,8,7,6,10,"clay"];
hombre58=["Gonzalez, Fernando(CHI)",9,7,7,7,7,7,8,9,7,8,10,"clay"];
hombre59=["Gonz�lez, M�ximo(ARG)",8,7,5,6,8,7,6,7,7,7,10,"clay"];
...
hombre254=["Guti�rrez-Ferrol, Sergio(ESP)",8,6,5,6,8,7,6,6,7,6,10,"clay"];
...
hombre83=["L�pez, Feliciano(ESP)",8,7,8,8,7,7,9,9,6,7,10,"hardcourt"];
hombre231=["L�pez, Marc(ESP)",9,7,9,7,8,6,8,7,8,8,10,"clay"];
...
hombre183=["Mart�, Javier(ESP)",7,8,7,6,7,7,6,6,7,7,10,"clay"];
hombre277=["Martin, Andrej(SVK)",6,6,6,6,7,6,6,6,6,6,10,"hardcourt"];
hombre89=["Mass�, Nicol�s(CHI)",8,6,5,5,6,6,8,7,6,10,"clay"];
...
hombre255=["Men�ndez Maceiras, Adri�n(ESP)",7,7,6,4,7,7,7,7,5,7,10,"hardcourt"];
...
hombre95=["M�naco, Juan(ARG)",8,7,7,6,8,8,7,7,8,8,10,"clay"];
hombre96=["Monfils, Gael(FRA)",8,7,7,7,8,8,8,9,8,7,10,"clay"];
hombre97=["Monta��s, Albert(ESP)",7,7,6,7,7,7,7,7,7,7,10,"clay"];
...
hombre215=["Mu�oz-De La Nava, Daniel(ESP)",7,6,6,7,6,7,6,7,6,6,10,"clay"];
hombre98=["Murray, Andy(GBR)",8,9,8,9,9,9,9,9,9,9,10,"hardcourt"];
hombre99=["Nadal, Rafael(ESP)",9,8,7,8,10,9,7,9,10,9,10,"clay"];
hombre100=["Nalbandi�n, David(ARG)",7,9,7,6,6,7,7,7,9,7,10,"hardcourt"];
hombre268=["Naso, Gianluca(ITA)",6,7,5,6,7,6,6,6,7,6,10,"clay"];
hombre195=["Navarro, Iv�n(ESP)",6,7,8,5,6,6,7,7,6,6,10,"clay"];
...
hombre310=["P�rez Sanz, David(ESP)",7,6,5,5,8,7,6,6,7,6,10,"clay"];
...
hombre151=["Ram�rez Hidalgo, Rub�n(ESP)",7,7,5,5,7,8,6,7,7,8,10,"clay"];
...
hombre318=["Rodr�guez, Ricardo(VEN)",7,6,6,5,7,7,5,6,7,6,10,"clay"];
...
hombre282=["Saavedra, Crist�bal(CHI)",7,6,5,6,7,7,6,7,6,6,10,"clay"];
...
hombre287=["Velotti, Agust�n(ARG)",7,7,5,6,6,7,6,6,7,7,10,"clay"];
...
hombre326=["Cabal, Juan Sebasti�n(COL)",7,6,7,6,7,7,6,5,7,6,10,"clay"];
...
hombre331=["Gonz�lez, Santiago(MEX)",6,7,7,7,5,6,6,7,6,5,10,"hardcourt"];
...
hombre333=["Klaasen, Raven(RSA)",6,6,6,6,6,6,8,6,7,5,10,"hardcourt"];
...
hombre336=["L�pez, Marc(ESP)",8,6,7,6,8,8,6,6,7,6,10,"clay"];
...
hombre340=["Matkowski, Marcin(POL)",6,5,7,7,6,6,6,7,6,6,10,"hardcourt"];
hombre341=["Melo, Marcelo(BRA)",6,6,7,7,6,6,6,7,6,7,10,"hardcourt"];
hombre342=["Mirnyi, Max(BLR)",7,7,8,6,5,5,7,7,5,7,10,"grass"];
hombre343=["Murray, Jamie(GBR)",6,7,7,5,7,6,7,7,6,5,10,"clay"];
hombre344=["Nestor, Daniel(CAN)",7,7,7,6,5,5,7,6,7,7,10,"hardcourt"];
hombre345=["Nielsen, Frederik(DEN)",6,7,8,6,5,5,6,6,7,5,10,"grass"];
hombre346=["Paes, Leander(IND)",7,7,6,7,6,6,5,5,7,7,10,"grass"];
hombre385=["Peers, John(AUS)",6,6,7,7,6,6,7,7,6,6,10,"hardcourt"];
hombre347=["Peya, Alexander(AUT)",7,6,7,6,6,7,7,6,7,5,10,"hardcourt"];
hombre348=["Polasek, Filip(SVK)",7,6,7,6,5,5,7,7,7,6,10,"clay"];
hombre349=["Qureshi, Aisam-ul-Haq(PAK)",6,6,7,7,5,5,7,7,8,6,10,"clay"];
hombre350=["Ram, Andy(ISR)",6,6,7,6,6,6,5,7,6,5,10,"hardcourt"];
hombre351=["Ratiwana, Sanchai(THA)",5,5,7,6,8,6,6,5,6,5,10,"hardcourt"];
hombre352=["Ratiwana, Sonchat(THA)",5,6,7,5,8,5,5,5,8,5,10,"hardcourt"];
hombre353=["Rojer, Jean-Julien(NED)",6,6,8,6,6,5,7,7,7,6,10,"carpet"];
hombre354=["Soares, Bruno(BRA)",6,6,7,7,6,7,7,6,7,5,10,"hardcourt"];
...
veterano7=["Corretja, �lex(ESP)",8,8,8,8,9,9,7,8,9,9,10,"clay"];
...
veterano11=["Gaudio, Gast�n(ARG)",8,9,8,9,8,9,7,8,9,8,10,"clay"];
...
veterano17=["Moy�, Carlos(ESP)",10,8,9,7,8,9,8,9,8,8,10,"clay"];
...
veterano24=["Gonz�lez, Fernando(CHI)",9,7,7,7,9,9,8,9,8,9,10,"clay"];
veterano25=["Stich, Michael(GER)",9,8,9,9,9,7,9,7,8,9,10,"grass"];
veterano26=["R�os, Marcelo(CHI)",8,9,8,10,8,9,7,7,10,8,10,"clay"];
...
//Jugadores-Raquetas
//jugadorraqueta=["Nombre del jugador" (Exacto al que sale en el desplegable de jugadores),posici�n en el array de raquetas];

jugadoresraquetas=new Array();
jugadoresraquetas[68]=["Agassi, Andre(USA)",23]; //veterano
jugadoresraquetas[1]=["Almagro, Nicol�s(ESP)",1];
jugadoresraquetas[27]=["Anderson, Kevin(RSA)",6];
jugadoresraquetas[55]=["Arguello, Facundo(ARG)",19];
jugadoresraquetas[2]=["Artu�edo, Andr�s(ESP)",0];
...
jugadoresraquetas[3]=["Carre�o-Busta, Pablo(ESP)",0];
...
jugadoresraquetas[9]=["Del Potro, Juan Mart�n(ARG)",12];
...
jugadoresraquetas[4]=["Garc�a-L�pez, Guillermo(ESP)",0];
...
jugadoresraquetas[101]=["L�pez, Feliciano(ESP)",1];
jugadoresraquetas[47]=["L�pez, Marc(ESP)",21];
jugadoresraquetas[44]=["Marchenko, Illya(UKR)",0];
jugadoresraquetas[49]=["Mart�, Javier(ESP)",17];
...
jugadoresraquetas[54]=["M�naco, Juan(ARG)",19];
...
jugadoresraquetas[14]=["Velotti, Agust�n(ARG)",0];
