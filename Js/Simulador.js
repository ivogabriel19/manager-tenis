  ...
  function calcularLesion(nomb_p,nomb_g){
	  ...
	  switch(opc)
	  {
			...
			else
			{
				...
				if(afecta > 70)
				{
					...
					mensaje="El jugador " + nomb_p + " ha sufrido " + cad + ", pero puede continuar.\n";
	  				mensaje=mensaje + "Esta lesi�n ha afectado a su velocidad(-" + spe_nueva + ") y a su resistencia(-" + sta_nueva +").";
	  				alert(mensaje);
					lesion1=50;
					lesion2=50;
					if(nomb_p == nomb1)
				...
				else
				{
					cad = "un golpe en el codo";
					mensaje="El jugador " + nomb_p + " ha sufrido " + cad + ", pero puede continuar.\n";
	  				mensaje=mensaje + "Esta lesi�n no ha afectado  jugador.";
					alert(mensaje);
					lesion1=50;
					lesion2=50;
					partido(fore1,back1,vol1,drop1,spe1,sta1,ser1,pow1,rest1,form1,fore2,back2,vol2,drop2,spe2,sta2,ser2,pow2,rest2,form2,punto1,punto2,game1,game2,set1,set2,control);
		...
		case 1:
			...
			{
				fm = Math.round(Math.random());
				cad = "una contusi�n en la rodilla(-" + fm + " de forma) ";
				mensaje="El jugador " + nomb_p + " ha sufrido " + cad + "y no puede continuar.\n";
	  			mensaje=mensaje + "Se declara como ganador a " + nomb_g;
	  			alert(mensaje);
				set1=6;
			...
			{
				cad = "una leve contusi�n en la rodilla";
				mensaje="El jugador " + nomb_p + " ha sufrido " + cad + ", pero puede continuar.\n";
	  			mensaje=mensaje + "Esta lesi�n no ha afectado al jugador.";
	  			alert(mensaje);
				lesion1=50;
				lesion2=50;
				partido(fore1,back1,vol1,drop1,spe1,sta1,ser1,pow1,rest1,form1,fore2,back2,vol2,drop2,spe2,sta2,ser2,pow2,rest2,form2,punto1,punto2,game1,game2,set1,set2,control);
		...
		case 2:
			...
			if(cont > 95)
			{
				...
				mensaje="El jugador " + nomb_p + " ha sufrido " + cad + "y no puede continuar, debido a que el fisioterapeuta ha cre�do que podr�a complicarse.\n";
	  			mensaje=mensaje + "Se declara como ganador a " + nomb_g;
	  			alert(mensaje);
				set1=6;
				mensajeExpuesto=true;
		...
		case 3:
			...
			if(cont > 80)
			{
				cad = "una contusi�n al caer al suelo(-1 de forma) ";
				mensaje="El jugador " + nomb_p + " ha sufrido " + cad + "y no puede continuar.\n";
	  			mensaje=mensaje + "Se declara como ganador a " + nomb_g;
	  			alert(mensaje);
				set1=6;
			...
			else
			{
				...
				if(afecta > 65)
				{
					...
					if(opc2==1)
					{
						cad = "una contusi�n en el brazo al caer al suelo";
						pow_nueva = Math.round(Math.random()*2)+1;
						fore_nueva = Math.round(Math.random()*2)+1;
						back_nueva = Math.round(Math.random()*2)+1;
						mensaje="El jugador " + nomb_p + " ha sufrido " + cad + ", pero puede continuar.\n";
	  					mensaje=mensaje + "Esta lesi�n ha afectado a su potencia(-" + pow_nueva + "), a su drive(-" + fore_nueva +") y a su rev�s(-" + back_nueva + ").";
	  					alert(mensaje);
						lesion1=50;
						lesion2=50;
						if(nomb_p == nomb1)
					...
					{
						cad = "una contusi�n en la pierna al caer al suelo";
						sta_nueva = Math.round(Math.random()*2)+1;
						spe_nueva = Math.round(Math.random()*2)+1;
						mensaje="El jugador " + nomb_p + " ha sufrido " + cad + ", pero puede continuar.\n";
	  					mensaje=mensaje + "Esta lesi�n ha afectado a su velocidad(-" + spe_nueva + ") y a su resistencia(-" + sta_nueva +").";
				...
				{
					cad = "una contusi�n al caer al suelo";
					mensaje="El jugador " + nomb_p + " ha sufrido " + cad + ", pero puede continuar.\n";
	  				mensaje=mensaje + "Esta lesi�n no ha afectado  jugador.";
					alert(mensaje);
					lesion1=50;
		...
		case 4:
			...
			if(cont > 80)
			{
				cad = "una sobrecarga en el b�ceps(-2 de forma) ";
				mensaje="El jugador " + nomb_p + " ha sufrido " + cad + "y no puede continuar.\n";
	  			mensaje=mensaje + "Se declara como ganador a " + nomb_g;
	  			alert(mensaje);
				set1=6;
			...
			else
			{
				...
				if(afecta > 40)
				{
					cad = "una sobrecarga en el b�ceps";
					pow_nueva = Math.round(Math.random()*2)+1;
					fore_nueva = Math.round(Math.random()*2)+1;
					back_nueva = Math.round(Math.random()*2)+1;
					mensaje="El jugador " + nomb_p + " ha sufrido " + cad + ", pero puede continuar.\n";
				...
				{
					cad = "una sobrecarga leve en el b�ceps";
					mensaje="El jugador " + nomb_p + " ha sufrido " + cad + ", pero puede continuar.\n";
	  				mensaje=mensaje + "Esta lesi�n no ha afectado  jugador.";
					alert(mensaje);
					lesion1=50;
		...
		case 6:
			...
			if(cont > 80)
			{
				cad = "una contractura en el tr�ceps(-2 de forma) ";
				mensaje="El jugador " + nomb_p + " ha sufrido " + cad + "y no puede continuar.\n";
	  			mensaje=mensaje + "Se declara como ganador a " + nomb_g;
	  			alert(mensaje);
				set1=6;
			...
			else
			{
				...
				if(afecta > 30)
				{
					cad = "una contractura en el tr�ceps";
					spe_nueva = Math.round(Math.random()*2)+1;
					sta_nueva = Math.round(Math.random()*2)+1;
					mensaje="El jugador " + nomb_p + " ha sufrido " + cad + ", pero puede continuar.\n";
	  				mensaje=mensaje + "Esta lesi�n ha afectado a su velocidad(-" + spe_nueva + ") y a su resistencia(-" + sta_nueva +").";
			...
			else
			{
				...
				if(afecta > 30)
				{
					...
					if(opc2 < 81)
					{
						...
						spe_nueva = Math.round(Math.random()*2)+1;
						mensaje="El jugador " + nomb_p + " ha sufrido " + cad + ", pero puede continuar.\n";
	  					mensaje=mensaje + "Esta lesi�n ha afectado a su velocidad(-" + spe_nueva + ").";
	  					alert(mensaje);
					}
					if(opc2 > 81 && opc2 < 96)
					{
		...
		case 8:
			...
			if(cont > 95)
			{
				cad = "un esguince grave de mu�eca(-4 de forma) ";
				mensaje="El jugador " + nomb_p + " ha sufrido " + cad + "y no puede continuar.\n";
	  			mensaje=mensaje + "Se declara como ganador a " + nomb_g;
	  			alert(mensaje);
				set1=6;
			...
			else
			{
				...
				if(afecta > 30)
				{
					...
					if(opc2 < 81)
					{
						cad = "un esguince leve de mu�eca";
						fore_nueva = Math.round(Math.random()*2)+1;
						back_nueva = Math.round(Math.random()*2)+1;
						mensaje="El jugador " + nomb_p + " ha sufrido " + cad + ", pero puede continuar.\n";
	  					mensaje=mensaje + "Esta lesi�n ha afectado a su drive(-" + fore_nueva + ") y a su rev�s(-" + back_nueva + ").";
	  					alert(mensaje);
						if(nomb_p == nomb1)
						{
							fore1 = fore1 - fore_nueva;
					...
					if(opc2 > 81 && opc2 < 96)
					{
						cad = "un esguince moderado de mu�eca";
						fore_nueva = Math.round(Math.random()*3)+1;
						back_nueva = Math.round(Math.random()*3)+1;
						ser_nueva = Math.round(Math.random()*2)+1;
						mensaje="El jugador " + nomb_p + " ha sufrido " + cad + ", pero puede continuar.\n";
	  					mensaje=mensaje + "Esta lesi�n ha afectado a su drive(-" + fore_nueva + "), a su rev�s(-" + back_nueva + ") y a su servicio(-" + ser_nueva + ").";
	  					alert(mensaje);
						if(nomb_p == nomb1)
						{
							fore1 = fore1 - fore_nueva;
					...
					if(opc2 > 95)
					{
						cad = "un esguince bastante fuerte de mu�eca";
						...
						mensaje="El jugador " + nomb_p + " ha sufrido " + cad + " y, aunque bastante mermado, puede continuar.\n";
	  					mensaje=mensaje + "Esta lesi�n ha afectado a su drive(-" + fore_nueva + "), a su rev�s(-" + back_nueva + "), a su servicio(-" + ser_nueva + "), a su volea(-" + vol_nueva + ") y a su dejada(-" + drop_nueva + ").";
	  					alert(mensaje);
						if(nomb_p == nomb1)
						{
							fore1 = fore1 - fore_nueva;
			...
			else
			{
				...
				if(afecta > 20)
				{
					...
					if(opc2 < 81)
					{
						...
						mensaje="El jugador " + nomb_p + " ha sufrido " + cad + ", pero puede continuar.\n";
	  					mensaje=mensaje + "Esta lesi�n ha afectado a su velocidad(-" + spe_nueva + ") y a su resto(-" + rest_nueva + ").";
	  					alert(mensaje);
						if(nomb_p == nomb1)
						{
							spe1 = spe1 - spe_nueva;
					...
					if(opc2 > 81 && opc2 < 96)
					{
						...
						sta_nueva = Math.round(Math.random()*2)+1;
						mensaje="El jugador " + nomb_p + " ha sufrido " + cad + ", pero puede continuar.\n";
	  					mensaje=mensaje + "Esta lesi�n ha afectado a su velocidad(-" + spe_nueva + "), a su resto(-" + rest_nueva + ") y a su resistencia(-" + sta_nueva + ").";
	  					alert(mensaje);
						if(nomb_p == nomb1)
						{
							spe1 = spe1 - spe_nueva;
					...
					if(opc2 > 95)
					{
						...
						pow_nueva = Math.round(Math.random()*2)+1;
						mensaje="El jugador " + nomb_p + " ha sufrido " + cad + " y, aunque bastante mermado, puede continuar.\n";
	  					mensaje=mensaje + "Esta lesi�n ha afectado a su velocidad(-" + spe_nueva + "), a su resto(-" + rest_nueva + "), a su resistencia(-" + sta_nueva + ") y a su potencia(-" + pow_nueva + ").";
	  					alert(mensaje);
						if(nomb_p == nomb1)
						{
							spe1 = spe1 - spe_nueva;
		...
		case 10:
			...
			if(cont > 90)
			{
				cad = "un tir�n en el b�ceps(-2 de forma) ";
				mensaje="El jugador " + nomb_p + " ha sufrido " + cad + "y no puede continuar.\n";
	  			mensaje=mensaje + "Se declara como ganador a " + nomb_g;
	  			alert(mensaje);
				set1=6;
			...
			else
			{
				...
				if(afecta > 40)
				{
					cad = "un tir�n en el b�ceps";
					ser_nueva = Math.round(Math.random()*2)+1;
					rest_nueva = Math.round(Math.random()*2)+1;
					mensaje="El jugador " + nomb_p + " ha sufrido " + cad + ", pero puede continuar.\n";
	  				mensaje=mensaje + "Esta lesi�n ha afectado a su servicio(-" + ser_nueva + ") y a su resto(-" + rest_nueva +").";
	  				alert(mensaje);
					lesion1=50;
					lesion2=50;
					if(nomb_p == nomb1)
				...
				{
					cad = "un tir�n leve en el b�ceps";
					mensaje="El jugador " + nomb_p + " ha sufrido " + cad + ", pero puede continuar.\n";
	  				mensaje=mensaje + "Esta lesi�n no ha afectado  jugador.";
					alert(mensaje);
					lesion1=50;
		...
		case 11:
			...
			if(cont > 90)
			{
				cad = "una subluxaci�n de mu�eca(-2 de forma) ";
				mensaje="El jugador " + nomb_p + " ha sufrido " + cad + "y no puede continuar.\n";
	  			mensaje=mensaje + "Se declara como ganador a " + nomb_g;
	  			alert(mensaje);
				set1=6;
			...
			else
			{
				...
				if(afecta > 50)
				{
					cad = "una subluxaci�n de mu�eca";
					ser_nueva = Math.round(Math.random()*2)+1;
					drop_nueva = Math.round(Math.random()*2)+1;
					mensaje="El jugador " + nomb_p + " ha sufrido " + cad + ", pero puede continuar.\n";
	  				mensaje=mensaje + "Esta lesi�n ha afectado a su servicio(-" + ser_nueva + ") y a su dejada(-" + drop_nueva +").";
	  				alert(mensaje);
					lesion1=50;
					lesion2=50;
					if(nomb_p == nomb1)
				...
				{
					cad = "una subluxaci�n leve de mu�eca";
					mensaje="El jugador " + nomb_p + " ha sufrido " + cad + ", pero puede continuar.\n";
	  				mensaje=mensaje + "Esta lesi�n no ha afectado  jugador.";
					alert(mensaje);
					lesion1=50;
		...
		case 12:
			...
			else
			{
				...
				if(afecta > 30)
				{
					...
					back_nueva = Math.round(Math.random()*2)+1;
					mensaje="El jugador " + nomb_p + " ha sufrido " + cad + ", pero puede continuar.\n";
	  				mensaje=mensaje + "Esta lesi�n ha afectado a su resistencia(-" + sta_nueva + "), a su drive(-" + fore_nueva +") y a su rev�s(-" + back_nueva + ").";
	  				alert(mensaje);
					lesion1=50;
					lesion2=50;
					if(nomb_p == nomb1)
		...
		case 13:
			...
			if(cont > 70)
			{
				cad = "una luxaci�n grave de la r�tula(-3 de forma) ";
				mensaje="El jugador " + nomb_p + " ha sufrido " + cad + "y no puede continuar.\n";
	  			mensaje=mensaje + "Se declara como ganador a " + nomb_g;
	  			alert(mensaje);
				set1=6;
			...
			else
			{
				...
				if(afecta > 10)
				{
					cad = "una luxaci�n leve de la r�tula";
					spe_nueva = Math.round(Math.random()*3)+1;
					mensaje="El jugador " + nomb_p + " ha sufrido " + cad + ", pero puede continuar.\n";
	  				mensaje=mensaje + "Esta lesi�n ha afectado a su velocidad(-" + spe_nueva + ").";
	  				alert(mensaje);
				...
				{
					cad = "una luxaci�n muy leve de la r�tula";
					mensaje="El jugador " + nomb_p + " ha sufrido " + cad + ", pero puede continuar.\n";
	  				mensaje=mensaje + "Esta lesi�n no ha afectado  jugador.";
					alert(mensaje);
					lesion1=50;
		...
		case 14:
			...
			if(cont > 70)
			{
				cad = "una luxaci�n grave de hombro(-3 de forma) ";
				mensaje="El jugador " + nomb_p + " ha sufrido " + cad + "y no puede continuar.\n";
	  			mensaje=mensaje + "Se declara como ganador a " + nomb_g;
	  			alert(mensaje);
				set1=6;
			...
			else
			{
				...
				if(afecta > 10)
				{
					cad = "una luxaci�n leve de hombro";
					fore_nueva = Math.round(Math.random()*3)+1;
					back_nueva = Math.round(Math.random()*3)+1;
					vol_nueva = Math.round(Math.random()*3)+1;
					drop_nueva = Math.round(Math.random()*3)+1;
					mensaje="El jugador " + nomb_p + " ha sufrido " + cad + ", pero puede continuar.\n";
	  				mensaje=mensaje + "Esta lesi�n ha afectado a su drive(-" + fore_nueva + "), a su rev�s(-" + back_nueva + "), a su volea(-" + vol_nueva + ") y a su dejada(-" + drop_nueva + ").";
	  				alert(mensaje);
					lesion1=50;
					lesion2=50;
					if(nomb_p == nomb1)
				...
				{
					cad = "una luxaci�n muy leve de hombro";
					mensaje="El jugador " + nomb_p + " ha sufrido " + cad + ", pero puede continuar.\n";
	  				mensaje=mensaje + "Esta lesi�n no ha afectado  jugador.";
					alert(mensaje);
					lesion1=50;
		...
		case 15:
			...
			else
			{
				...
				if(afecta > 10)
				{
					...
					rest_nueva = Math.round(Math.random()*2)+1;
					mensaje="El jugador " + nomb_p + " ha sufrido " + cad + ", pero puede continuar.\n";
	  				mensaje=mensaje + "Esta lesi�n ha afectado a su drive(-" + fore_nueva + "), a su rev�s(-" + back_nueva + ") y a su resto(-" + rest_nueva + ").";
	  				alert(mensaje);
					lesion1=50;
					lesion2=50;
					if(nomb_p == nomb1)
		...
		case 16:
			...
			if(cont > 80)
			{
				cad = "una distensi�n del recto anterior(-3 de forma) ";
				mensaje="El jugador " + nomb_p + " ha sufrido " + cad + "y no puede continuar.\n";
	  			mensaje=mensaje + "Se declara como ganador a " + nomb_g;
	  			alert(mensaje);
				set1=6;
			...
			else
			{
				...
				if(afecta > 10)
				{
					cad = "una leve distensi�n del recto anterior";
					fore_nueva = Math.round(Math.random()*3)+1;
					back_nueva = Math.round(Math.random()*3)+1;
					rest_nueva = Math.round(Math.random()*2)+1;
					vol_nueva = Math.round(Math.random()*2)+1;
					mensaje="El jugador " + nomb_p + " ha sufrido " + cad + ", pero puede continuar.\n";
	  				mensaje=mensaje + "Esta lesi�n ha afectado a su drive(-" + fore_nueva + "), a su rev�s(-" + back_nueva + "), a su resto(-" + rest_nueva + ") y a su volea(-" + vol_nueva + ").";
	  				alert(mensaje);
					lesion1=50;
					lesion2=50;
					if(nomb_p == nomb1)
				...
				{
					cad = "una distensi�n muy leve del recto anterior";
					mensaje="El jugador " + nomb_p + " ha sufrido " + cad + ", pero puede continuar.\n";
	  				mensaje=mensaje + "Esta lesi�n no ha afectado  jugador.";
					alert(mensaje);
					lesion1=50;
		...
		case 18:
			...
			break;
		case 19:
			cad = "una microrrotura en el cu�driceps(-4 de forma) ";
			mensaje="El jugador " + nomb_p + " ha sufrido " + cad + "y no puede continuar.\n";
	  		mensaje=mensaje + "Se declara como ganador a " + nomb_g;
	  		alert(mensaje);
			set1=6;
